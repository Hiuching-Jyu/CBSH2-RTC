...
void CBS::printResults() const
{
    ...
    cout << "num_of_duplicate_conflicts " << 0 << endl;
}
...
void CBS::saveResults(const string& fileName, const string& instanceName) const
{
	...
	stats << runtime << "," <<
		  ...
		  num_target_conflicts << "," << num_mutex_conflicts << "," << 0 << "," <<
		  ...
		  rectangle_helper.accumulated_runtime << "," << corridor_helper.accumulated_runtime << "," << mutex_helper.accumulated_runtime << "," << 0 << "," <<
